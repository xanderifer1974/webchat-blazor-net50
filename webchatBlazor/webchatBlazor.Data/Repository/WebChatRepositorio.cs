...
namespace webchatBlazor.Data.Repository
{
    public class WebChatRepositorio : IWebChatRepositorio
    {
        ...
        public WebChatRepositorio()
        {
            ...
            WebChat conversa1 = new(01, "MN-01", $"Funny: <h6>Alterar Pacotes de Canais:</h6>" +
                       $"<ul><li>MN-101 – Pacote Full</li>" +
                       $"<li>MN-102 – Pacote Filmes</li>" +
                       $"<li>MN-103 -  Pacote Básico</li>" +
                       $"</ul>");
            WebChat conversa2 = new(2, "MN-101", "Funny: Você escolheu o <b>Pacote Full</b>. Iremos providenciar a alteração.");
            WebChat conversa3 = new(3, "MN-102", "Funny: Você escolheu o <b>Pacote Filmes</b>. Iremos providenciar a alteração.");
            WebChat conversa4 = new(4, "MN-103", "Funny: Você escolheu o <b>Pacote Básico</b>. Iremos providenciar a alteração.");
            WebChat conversa5 = new(5, "MN-02", $"Funny: <h6>Alterar dados cadastrais:</h6>" +
                        $"<ul><li>MN-201 – Nome</li>" +
                        $"<li>MN-202 – RG</li>" +
                        $"<li>MN-203 - CPF</li>" +
                        $"<li>MN-204 - Telefone</li>" +
                        $"<li>MN-205 - Endereço</li>" +
                        $"</ul>");
            WebChat conversa6 = new(6, "MN-201", "Funny: Você escolheu o <b> Alteração do Nome</b>.Iremos prosseguir com a alteração.");
            WebChat conversa7 = new(7, "MN-202", "Funny: Você escolheu o <b> Alteração do RG</b>.Iremos prosseguir com a alteração.");
            WebChat conversa8 = new(8, "MN-203", "Funny: Você escolheu o <b> Alteração do CPF</b>.Iremos prosseguir com a alteração.");
            WebChat conversa9 = new(9, "MN-204", "Funny: Você escolheu o <b> Alteração do Telefone</b>.Iremos prosseguir com a alteração.");
            WebChat conversa10 = new(10, "MN-205", "Funny: Você escolheu o <b> Alteração do Endereço</b>.Iremos prosseguir com a alteração.");
            WebChat conversa11 = new(11, "MN-03", "Funny: Iremos enviar um técnico para a instalação do novo ponto.");
            WebChat conversa12 = new(12, "MN-04", $"Funny: <h6>Informe os seguintes dados para alterar endereço de assinatura:</h6>" +
                        $"<ul>" +
            ...
            WebChat conversa14 = new(14, "MN-05", "Funny: Informe o mês e ano no seguinte formato {mm/yyyy}, para que possamos enviar a seguinda via");
            WebChat conversa15 = new(15, "Mês e ano informados.", "Funny: A segunda via da fatura foi enviada para o e-mail cadastrado.");
            WebChat conversa16 = new(16, "MN-06", "Funny: Estaremos te encaminhando para um atendente do departamento financeiro. Favor aguardar");
            WebChat conversa17 = new(17, "MN-07", "Funny: Sua assinatura foi cancelada, enviaremos um e-mail com os dados de cancelamento");
            WebChat conversa18 = new(18, "MN-08", "Funny: Estaremos te encaminhando para algum atendente. Favor aguardar....");          
